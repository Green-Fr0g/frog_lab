...
parser = argparse.ArgumentParser(description="Train an AMP agent with frog_rl.")
...
parser.add_argument("--wandb_path", type=str, default=None, help="W&B run path or checkpoint path to resume from.")
parser.add_argument("--distributed", action="store_true", default=False, help="Run training with multiple GPUs.")
parser.add_argument("--export_io_descriptors", action="store_true", default=False, help="Export IO descriptors.")
parser.add_argument("--ray-proc-id", "-rid", type=int, default=None, help="Automatically configured by Ray.")
...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg):
    ...
    if args_cli.wandb_path:
        ...
        print(f"[INFO]: Resuming from W&B: {run_path}/{requested_file}")
