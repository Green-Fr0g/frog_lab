...
gym.register(
    id="FrogLab-Isaac-BeyondMimic-Flat-Unitree-G1-v0",
...
gym.register(
    id="FrogLab-Isaac-BeyondMimic-Flat-Unitree-G1-Wo-State-Estimation-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="FrogLab-Isaac-BeyondMimic-Flat-Unitree-G1-Low-Freq-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
